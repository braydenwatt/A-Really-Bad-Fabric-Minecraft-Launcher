...
class ModrinthPackWidget(QWidget):
    ...
    def mousePressEvent(self, event):
        if event.button() == Qt.LeftButton:
            # Find the parent AddInstanceWindow
            parent = self.parent()
            while parent and not isinstance(parent, AddInstanceWindow):
                parent = parent.parent()
            if parent:
                parent.select_modpack(self)
        super().mousePressEvent(event)

class AddInstanceWindow(QDialog):
        ...
        if self.current_section == "Modrinth":
            ...
            for mod in mod_list:
                ...
                try:
                    ...
                    print(file_names)
                    # Optional: get icon from project metadata
                    ...
                    mods_info.append(mod_entry)

                except requests.RequestException as e:
                    print(f"Error fetching data for version_id {version_id}: {e}")
            ...
            return {
                ...
                "selected_fabric_version": self.second_versions_list.currentItem().text() if self.second_versions_list.currentItem() else "",
                "image": image_data,
                "mod_data": None,
            }
